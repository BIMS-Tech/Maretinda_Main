 ...
 *     "amount": "99900",
 *     "currency": "PHP",
 *     "description": "Maretinda Vendor Subscription - Foundation Plan",
 *     "nonce": "...",
 *     "timestamp": "...",
 *     "signature": "...",
...
export async function POST(req: MedusaRequest, res: MedusaResponse): Promise<void> {
  try {
    ...
    try {
      ...
      const GiyaPayService = (await import("../../../../services/giyapay")).default
    ...
    const formData = {
      ...
      currency: "PHP",
      description: `Maretinda Vendor Subscription - ${plan.name} Plan`,
      nonce,
      timestamp,
      signature,
