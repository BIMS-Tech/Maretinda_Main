...
export async function generateMetadata({
  ...
  if (Object.keys(primeCategories).includes(category)) {
    const categoryName = primeCategories[category as keyof typeof primeCategories]
    const subCategories = categoryStructure[category as keyof typeof categoryStructure]
    const subcategoryName = subCategories[subcategory as keyof typeof subCategories]
      ...
      <main className="container">
        ...
        <div className={`p-8 rounded-xl mb-8 ${theme.bgClass}`}>
          <div className="flex items-center">
            ...
            <div>
              <div className={`text-sm ${theme.textClass} opacity-70 mb-2 uppercase tracking-wide`}>
                {categoryName}
              </div>
              <h1 className={`heading-xl uppercase ${theme.textClass} mb-2`}>{subcategoryName}</h1>
              <p className={`text-lg ${theme.textClass} opacity-80`}>
                Discover the best {subcategoryName.toLowerCase()} from trusted vendors
              </p>
            </div>
          </div>
        </div>
        ...
        {category === 'groceries' && (
          <div className="bg-green-50 p-6 rounded-lg mb-8 border border-green-200">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-bold text-green-800 mb-2">Fresh Delivery Available</h3>
                <p className="text-green-700">Same-day delivery for orders placed before 2 PM</p>
              </div>
        ...
        {category === 'food' && (
          <div className="bg-orange-50 p-6 rounded-lg mb-8 border border-orange-200">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-bold text-orange-800 mb-2">Hot Food Delivery</h3>
                <p className="text-orange-700">Order fresh meals with temperature-controlled delivery</p>
              </div>
        ...
        {category === 'accessories' && (
          <div className="bg-purple-50 p-6 rounded-lg mb-8 border border-purple-200">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-bold text-purple-800 mb-2">Premium Quality Guaranteed</h3>
                <p className="text-purple-700">Authentic accessories with quality assurance</p>
              </div>
        ...
        {category === 'shopping' && (
          <div className="bg-blue-50 p-6 rounded-lg mb-8 border border-blue-200">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-bold text-blue-800 mb-2">Fast & Reliable Shipping</h3>
                <p className="text-blue-700">Multiple shipping options with tracking available</p>
              </div>
        ...
        {category === 'fashion' && (
          <div className="bg-gray-50 p-6 rounded-lg mb-8 border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-bold text-gray-800 mb-2">Latest Fashion Trends</h3>
                <p className="text-gray-700">Curated collection from top brands and designers</p>
              </div>
