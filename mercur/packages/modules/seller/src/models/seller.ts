...
import { VendorShippingCredentials } from "./vendor-shipping-credentials";
import { VendorShippingConfig } from "./vendor-shipping-config";
...
export const Seller = model.define("seller", {
  ...
  // DFT (Data File Transfer) fields for bank transfers
  ...
  shippingCredentials: model.hasMany(() => VendorShippingCredentials, {
    mappedBy: "seller"
  }),
  shippingConfig: model.hasOne(() => VendorShippingConfig, {
    mappedBy: "seller"
  }).nullable(),
});
