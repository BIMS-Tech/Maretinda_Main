 ...
 *     type: string
 *     nullable: true
 *     description: Bank name for DFT transactions.
 *   dft_bank_code:
 *     type: string
 *     nullable: true
 *     description: Bank code for DFT transactions.
 *   dft_swift_code:
 *     type: string
 *     nullable: true
 *     description: SWIFT code for DFT transactions.
 *   dft_bank_address:
 *     type: string
 *     nullable: true
 *     description: Bank address for DFT transactions.
 *   dft_beneficiary_name:
 *     type: string
 *     nullable: true
 *     description: Beneficiary name for DFT transactions.
 *   dft_beneficiary_code:
 *     type: string
 *     nullable: true
 *     description: Beneficiary code for DFT transactions.
 *   dft_beneficiary_address:
 *     type: string
 *     nullable: true
 *     description: Beneficiary address for DFT transactions.
 *   dft_account_number:
 *     type: string
 *     nullable: true
 *     description: Account number for DFT transactions.
 *   member:
 *     type: object
 *     required:
 *       - name
...
export const VendorCreateSeller = z
  .object({
    ...
    dft_bank_name: z.string().nullish().optional(),
    dft_bank_code: z.string().nullish().optional(),
    dft_swift_code: z.string().nullish().optional(),
    dft_bank_address: z.string().nullish().optional(),
    dft_beneficiary_name: z.string().nullish().optional(),
    dft_beneficiary_code: z.string().nullish().optional(),
    dft_beneficiary_address: z.string().nullish().optional(),
    dft_account_number: z.string().nullish().optional(),
    member: z.object({
      name: z.string(),
