...
export async function GET(
  ...
  try {
    ...
    const tamaGeneration = results[0]
    ...
    try {
      ...
      console.log('[Admin TAMA Download] Service not in scope, registering with Awilix...')
    ...
    const filePath = path.join(tamaDir, tamaGeneration.file_name)
